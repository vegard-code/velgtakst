...
export const revalidate = 900; // ISR: 15 minutter
...
async function hentFylkeStatistikk() {
  try {
    ...
    // Teller antall aktive takstmenn per fylke
...
export default async function Home() {
  ...
  // Bruk JSON-data for bloggposter (statisk innhold)
  const bloggposter = data.bloggposter;

  // Tell totalt antall aktive takstmenn
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="bg-card-bg border border-card-border rounded-2xl p-8 sm:p-12 text-center max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-white mb-4">Om VelgTakst</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="border border-accent/40 text-accent hover:bg-accent/10 px-6 py-3 rounded-lg font-medium transition-colors"
            >
