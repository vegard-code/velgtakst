      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="portal-card p-6">
            ...
            {oppdrag.dokumenter && oppdrag.dokumenter.length > 0 ? (
              <div className="space-y-2">
                {oppdrag.dokumenter.map((dok: { id: string; navn: string; er_rapport: boolean }) => (
                  <div
                    key={dok.id}
                  ...
                  >
                    ...
                    <span className="text-sm text-[#1e293b] flex-1 truncate">{dok.navn}</span>
                    {dok.er_rapport && (
                      <span className="portal-badge portal-badge-blue text-xs">Rapport</span>
                    )}
                  </div>
                ))}
              </div>
            ) : (
              <p className="text-[#94a3b8] text-sm">Ingen dokumenter lastet opp</p>
            )}
          </div>
        </div>
